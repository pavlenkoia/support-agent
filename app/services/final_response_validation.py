...
def invalid_final_response(reason: str = "invalid_finalizer_output") -> dict[str, Any]:
...
def validate_final_response(
    ...
    if allow_technical and route == "retry_pending":
        return invalid_final_response(reason)
    ...
    if limit is not None and len(text) > limit:
        return invalid_final_response("output_too_long")
