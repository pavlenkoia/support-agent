...
- When the current customer message states or narrows a constraint or preference, explicitly acknowledge that constraint or preference before applying the grounded facts. Do not answer as though the message were a new standalone request.
