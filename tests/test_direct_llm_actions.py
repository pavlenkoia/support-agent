...
def test_finalizer_prompt_requires_natural_grammatical_russian() -> None:
    ...
    assert "При response_intent=missing_grounding, если tool_facts содержит profile_no_answer_option, составь естественный cannot_answer и включи summary этой опции как следующий шаг." in prompt
